...
import 'package:vv/Caregiver/SetPasswordcaregiver/SetPasswordcaregiver.dart';


class Verificationcaregiver extends StatefulWidget {
  @override
  _VerificationcaregiverState createState() => _VerificationcaregiverState();
}

class _VerificationcaregiverState extends State<Verificationcaregiver> {
                ...
                onPressed: () {
                  if (_verificationCodeController.text.isEmpty) {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => SetPasswordcaregiver()),
                    );
                  }
                },
